...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.img_ori = QtWidgets.QFrame(self.frame)
        self.img_ori.setStyleSheet("background-color: rgb(222, 221, 218);")
        self.img_ori.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.img_ori.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.img_grafik = QtWidgets.QFrame(self.frame)
        self.img_grafik.setStyleSheet("background-color: rgb(222, 221, 218);")
        self.img_grafik.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.img_grafik.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.img_grafik.setObjectName("img_grafik")
        self.verticalLayout_2.addWidget(self.img_grafik)
        ...
        self.img_thres = QtWidgets.QFrame(self.frame_6)
        self.img_thres.setStyleSheet("background-color: rgb(222, 221, 218);")
        self.img_thres.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.img_thres.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.img_thres.setObjectName("img_thres")
        self.verticalLayout_3.addWidget(self.img_thres)
        ...
        self.img_canny = QtWidgets.QFrame(self.frame_6)
        self.img_canny.setStyleSheet("background-color: rgb(222, 221, 218);")
        self.img_canny.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.img_canny.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.img_canny.setObjectName("img_canny")
        self.verticalLayout_3.addWidget(self.img_canny)
        ...
        self.img_morph = QtWidgets.QFrame(self.frame_3)
        self.img_morph.setStyleSheet("background-color: rgb(222, 221, 218);")
        self.img_morph.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.img_morph.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.img_morph.setObjectName("img_morph")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.img_morph)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.verticalLayout_4.addWidget(self.img_morph)
        ...
        self.img_label = QtWidgets.QFrame(self.frame_3)
        self.img_label.setStyleSheet("background-color: rgb(222, 221, 218);")
        self.img_label.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.img_label.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.img_label.setObjectName("img_label")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.img_label)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Grafik"))
